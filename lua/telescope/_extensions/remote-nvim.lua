  ...
  local possible_ssh_options = {
    {
      ...
      value = "ssh-config",
      help =
      [[Choosing this will allow you to choose one of the known hosts from your `ssh-config` files. The list used can be configured using the `ssh-config-files` flag.
